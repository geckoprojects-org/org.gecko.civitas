 ...
 * </p>
 * <ul>
 *   <li>{@link org.civitas.meter.intermediate.model.meterintermediate.impl.MeteringPointImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.civitas.meter.intermediate.model.meterintermediate.impl.MeteringPointImpl#getReadings <em>Readings</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MeteringPointImpl extends MinimalEObjectImpl.Container implements MeteringPoint {
	...
	protected EClass eStaticClass() {
		return MeterIntermediatePackage.Literals.METERING_POINT;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MeterIntermediatePackage.METERING_POINT__ID, oldId, id));
	}
	...
	public EList<MeterReading> getReadings() {
		if (readings == null) {
			readings = new EObjectResolvingEList<MeterReading>(MeterReading.class, this, MeterIntermediatePackage.METERING_POINT__READINGS);
		}
		return readings;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MeterIntermediatePackage.METERING_POINT__ID:
				return getId();
			case MeterIntermediatePackage.METERING_POINT__READINGS:
				return getReadings();
		}
