...
import org.civitas.units.model.units.*;
...
public class UnitsFactoryImpl extends EFactoryImpl implements UnitsFactory {
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case UnitsPackage.HOURS:
				return createHoursFromString(eDataType, initialValue);
			case UnitsPackage.KILOWATT_HOURS:
				return createKilowattHoursFromString(eDataType, initialValue);
			case UnitsPackage.DEGREES_CELSIUS:
				return createDegreesCelsiusFromString(eDataType, initialValue);
			case UnitsPackage.EINSTANT:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			...
			case UnitsPackage.KILOWATT_HOURS:
				return convertKilowattHoursToString(eDataType, instanceValue);
			case UnitsPackage.DEGREES_CELSIUS:
				return convertDegreesCelsiusToString(eDataType, instanceValue);
			case UnitsPackage.EINSTANT:
	 ...
	 * @generated
	 */
	public Integer createHoursFromString(EDataType eDataType, String initialValue) {
	 ...
	 * @generated
	 */
	public Double createKilowattHoursFromString(EDataType eDataType, String initialValue) {
	 ...
	 * @generated
	 */
	public String convertKilowattHoursToString(EDataType eDataType, Object instanceValue) {
		return super.convertToString(eDataType, instanceValue);
	}
	 ...
	 * @generated
	 */
	public Double createDegreesCelsiusFromString(EDataType eDataType, String initialValue) {
		return (Double)super.createFromString(eDataType, initialValue);
	}
	 ...
	 * @generated
	 */
	public String convertDegreesCelsiusToString(EDataType eDataType, Object instanceValue) {
		return super.convertToString(eDataType, instanceValue);
	}
