 ...
 * </p>
 * <ul>
 *   <li>{@link org.civitas.meter.target.impl.MeterImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.civitas.meter.target.impl.MeterImpl#getSerialNumber <em>Serial Number</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MeterImpl extends MinimalEObjectImpl.Container implements Meter {
	...
	protected EClass eStaticClass() {
		return targetPackage.Literals.METER;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, targetPackage.METER__ID, oldId, id));
	}
	...
	public void setSerialNumber(String newSerialNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, targetPackage.METER__SERIAL_NUMBER, oldSerialNumber, serialNumber));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case targetPackage.METER__ID:
				return getId();
			case targetPackage.METER__SERIAL_NUMBER:
