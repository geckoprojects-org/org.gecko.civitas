 ...
 * <!-- end-user-doc -->
 * @see org.civitas.meter.target.util.targetResourceImpl
 * @generated
 */
public class targetResourceFactoryImpl extends ResourceFactoryImpl {
	...
	public Resource createResource(URI uri) {
		Resource result = new targetResourceImpl(uri);
		return result;
	}
	...
	public Map<String, Object> getServiceProperties() {
		...
		properties.put(EMFNamespaces.EMF_CONFIGURATOR_NAME, targetPackage.eNAME);
