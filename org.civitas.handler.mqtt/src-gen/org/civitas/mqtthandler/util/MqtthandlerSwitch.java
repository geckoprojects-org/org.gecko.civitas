 ...
 * @generated
 */
public class MqtthandlerSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MqtthandlerPackage.MQTT_EVENT_HANDLER_CONFIG: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Mqtt Event Handler Config</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Mqtt Event Handler Config</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseMqttEventHandlerConfig(MqttEventHandlerConfig object) {
		return null;
	}
