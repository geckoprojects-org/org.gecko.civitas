 ...
 * </p>
 * <ul>
 *   <li>{@link org.civitas.osgi.component.impl.ConfigurationImpl#getPid <em>Pid</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConfigurationImpl extends MinimalEObjectImpl.Container implements Configuration {
	...
	protected EClass eStaticClass() {
		return ComponentConfigPackage.Literals.CONFIGURATION;
	}
	...
	public void setPid(String newPid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComponentConfigPackage.CONFIGURATION__PID, oldPid, pid));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ComponentConfigPackage.CONFIGURATION__PID:
				return getPid();
		}
