...
public class GltPackageImpl extends EPackageImpl implements GltPackage {
	 ...
	 * @see org.civitas.glt.model.glt.GltPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static GltPackage init() {
		...
		Object registeredPackage = EPackage.Registry.INSTANCE.getEPackage(BuildingSensorPackage.eNS_URI);
		BuildingSensorPackageImpl theBuildingSensorPackage = (BuildingSensorPackageImpl)(registeredPackage instanceof BuildingSensorPackageImpl ? registeredPackage : BuildingSensorPackage.eINSTANCE);
	 ...
	 */
	@Override
	public EAttribute getBuilding_City() {
	 ...
	 */
	@Override
	public EAttribute getBuilding_Zip() {
	 ...
	 */
	@Override
	public EAttribute getContact_BuildingId() {
	 ...
	 */
	@Override
	public EAttribute getContact_Role() {
	 ...
	 */
	@Override
	public EAttribute getContact_PhoneNumber() {
	...
	public void createPackageContents() {
		...
		createEAttribute(contactEClass, CONTACT__ROLE);
		createEAttribute(contactEClass, CONTACT__EMAIL);
		createEAttribute(contactEClass, CONTACT__PHONE_NUMBER);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getBuilding_Id(), ecorePackage.getEIntegerObject(), "id", null, 1, 1, Building.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
