 ...
 * @generated
 */
public class MeterSourceSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MeterSourcePackage.BASIC_DATA: {
				BasicData basicData = (BasicData)theEObject;
				T result = caseBasicData(basicData);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MeterSourcePackage.OPERATING_DATA: {
				OperatingData operatingData = (OperatingData)theEObject;
				T result = caseOperatingData(operatingData);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MeterSourcePackage.METER: {
				Meter meter = (Meter)theEObject;
				T result = caseMeter(meter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MeterSourcePackage.READING: {
				Reading reading = (Reading)theEObject;
				T result = caseReading(reading);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MeterSourcePackage.CUSTOMER: {
			...
			case MeterSourcePackage.REMOTE_READING: {
				RemoteReading remoteReading = (RemoteReading)theEObject;
				T result = caseRemoteReading(remoteReading);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Operating Data</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Operating Data</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseOperatingData(OperatingData object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Remote Reading</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Remote Reading</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRemoteReading(RemoteReading object) {
		return null;
	}
